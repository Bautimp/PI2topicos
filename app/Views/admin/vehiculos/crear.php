            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/vehiculos/guardar') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label" style="color: #f8f9fa !important;">Marca</label>
                                <input type="text" class="form-control" name="marca" required placeholder="Ej: Toyota">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: #f8f9fa !important;">Modelo</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label" style="color: #f8f9fa !important;">Año</label>
                                <input type="number" class="form-control" name="anio" required placeholder="2023">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" style="color: #f8f9fa !important;">Asientos / Plazas</label>
                                <input type="number" class="form-control" name="asientos" required placeholder="5">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" style="color: #f8f9fa !important;">Motor</label>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label class="form-label" style="color: #f8f9fa !important;">Kilometraje Actual</label>
                                <input type="number" class="form-control" name="kilometraje" required placeholder="15000">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: #f8f9fa !important;">Precio de Alquiler por Día ($)</label>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label class="form-label fw-bold" style="color: #f8f9fa !important;">Imágenes del Vehículo (Máximo 10)</label>
                                <input type="file" class="form-control" name="imagenes[]" multiple accept="image/jpeg, image/png, image/jpg">
                                <small class="text-muted" style="color: #a0aab2 !important;">Formatos aceptados: JPG, PNG. Puedes seleccionar varios archivos a la vez manteniendo presionada la tecla Ctrl.</small>
                            </div>
                        </div>
